...
const observer = new IntersectionObserver(handleIntersection, { threshold: 0.4});//threshold is used to see how far till it in the viewer sight lower the faster
